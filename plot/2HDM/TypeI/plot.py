...
plt.plot(mA,length2width(OA5),ls='-',c='c',label=r'$\tan\beta=10^4$')
plt.plot(mA,length2width(OA4),ls='-',c='m',label=r'$\tan\beta=10^3$')
plt.plot(mA,length2width(OA3),ls='-',c='b',label=r'$\tan\beta=10^2$')
plt.plot(mA,length2width(OA2),ls='-',c='g',label=r'$\tan\beta=10$')
plt.plot(mA,length2width(OA1),ls='-',c='r',label=r'$\tan\beta=1$')

plt.legend(loc=1,prop={'size': 14},framealpha=0.0)

x=np.arange(0.1, 10, 0.01)
plt.fill_between(x, 102.*x/1000., 13081.7*x/1000.,color='0.8')
...
plt.title(r'Type-I',fontsize=16)
